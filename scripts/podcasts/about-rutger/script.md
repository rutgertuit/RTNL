# Episode 06 — The File on Rutger (guests only, no host)
#
# Format: 5-guest panel, Rutger ABSENT. Frits (the Nestor), Dino (the
# creative dinosaur), Oracle (strategy oracle), Angela (the unflappable
# chief of staff) and Marie (precision interjections) go through Rutger's
# press clippings, bio and website while he is out of the room — under the
# running irony that he prompted every one of them into existence.
#
# Accompanies the About / Media-Kit section.
...
DINO: Marie, that is the entire problem with him in one sentence.
...
ANGELA: The website itself. Six long pieces. A games section. A media kit. And one line at the bottom of the homepage.
...
ANGELA: There is a real one. Director of something, at Google Benelux. It appears once, quietly, in the long bio. Everywhere else he leads with "technical creative." He is the only executive I have met who buries the title and promotes the hobby.

DINO: Because the title bores him.
...
DINO: [laughs] Tell him the dinosaur says hello.
